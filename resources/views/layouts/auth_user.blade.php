...
<div class="w3-top">
    ...
    <div class="w3-row w3-large w3-light-grey">
        <div class="topnavv" id="myTopnav">
            ...
            <a href="/#services">{{ trans('sentence.Services')}}</a>
            <a href="/#plans">{{ trans('sentence.Pricing')}}</a>
            <a href="/#about">{{ trans('sentence.Team')}}</a>
            <a href="{{ url('/about') }}">{{ trans('sentence.About Us')}}</a>
            <a href="/#contact"><i class="fa fa-fw fa-envelope"></i>{{ trans('sentence.Contact')}}</a>
...
<div class="userpanel-menu" >
  ...
  <p style="font-size:50px;   color:rgb(22, 20, 20);">{{ trans('sentence.Hello')}} {{ Auth::user()->name }}</p>
<div class="userpanel-eklenti">

      <a href="{{route('customerprofile',(Auth::user()->id ) )}}"class="button" > {{ trans('sentence.view my profile')}}</a>
      <a href="{{route('editprofile',(Auth::user()->id ) )}}"class="button"  >{{ trans('sentence.Edit my information')}}</a>
      <a href="{{ url('/userpanel') }}"class="button"  >{{ trans('sentence.Choose a service')}}</a>
      <a href="{{ url('orders/user') }}"class="button" >{{ trans('sentence.My Project')}}</a>
